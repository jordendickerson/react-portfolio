...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://jordendickerson.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post"
    };
  ...
  deleteImage(imageType) {
    axios.delete(
      `https://jordendickerson.devcamp.space/portfolio/delete-portfolio-blog-image/${this.props
      .blogToEdit.id}?image_type=${imageType}`,
  ...
  componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://jordendickerson.devcamp.space/portfolio/portfolio_blogs/${this.props.blogToEdit.id}`,
        apiAction: "patch"
      });
    }
  }
  ...
  handleSubmit(event) {
    axios({
      ...
      .catch((error) => {
        console.log("Error from blog-form handleSubmit", error);
      });
